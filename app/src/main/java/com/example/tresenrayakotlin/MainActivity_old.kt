    ...
    private fun inicializarVista() {
        try {
            ...
            botonesCasillas = Array(3) { fila ->
                Array(3) { columna ->
                    val buttonId = when (fila * 3 + columna) {
                        0 -> R.id.botonCasilla00
                        1 -> R.id.botonCasilla01
                        2 -> R.id.botonCasilla02
                        3 -> R.id.botonCasilla10
                        4 -> R.id.botonCasilla11
                        5 -> R.id.botonCasilla12
                        6 -> R.id.botonCasilla20
                        7 -> R.id.botonCasilla21
                        8 -> R.id.botonCasilla22
